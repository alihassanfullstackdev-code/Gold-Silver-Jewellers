...
export default function Collections() {
  ...
  const itemsPerPage = 8; // Ek page par kitne products dikhane hain
  ...
  const handleMetalChange = (metal: string) => {
    ...
    setCurrentPage(1); // Category change par pehle page par wapas le jao
  };
      ...
      <section className="relative min-h-screen">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10 pt-48 pb-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            {/* Pagination Controls - Sirf tab dikhein jb 1 se zyada page hon */}
